...
export default function Settings() {
  ...
  return (
    <main className="flex flex-col flex-grow items-center bg-gradient-to-r from-purple-500 to-pink-500 w-screen">
      <Form method="POST" className="mt-8 w-11/12 flex-grow">
